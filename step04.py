        ...
        <html>
            ...
            <a id="hidden_url" href="https://play.google.com/store/apps/details?id=com.appcollection.web2app">
                ...
                <div style="text-align: left;">
                    ...
                    <a href="https://appcollection.in/InstantWeb2App/downloads/{appname_link}" class="button"><img src=f"{app_logo_url}" alt="Download" style="width: 25px; height: 25px;"> Download Your App ({appname_link})</a><br>
                    <br>
