...
if __name__ == "__main__":
    try:
      ...
      # Example query
      query = "SELECT * FROM app_data WHERE status IS NULL ORDER BY id DESC LIMIT 1"
      ...
      try:
          if len(app_logo_name)>5:
              ...
              download_image('https://appcollection.in/InstantWeb2App/V06/uploads/'+app_logo_name, 'ic_launcher.png')
